...
interface NextStepsProps {
  ...
  tone: 'brandAccent' | 'formAccent';
}
export function NextSteps({ environment, tone }: NextStepsProps) {
  return (
    <Box
      paddingY="xxlarge"
      ...
      <ContentBlock width="large">
        <Stack space="xxlarge">
          <Stack space="xlarge">
            ...
            <Stack space="medium" align="center">
              <Text size="large">
                <Strong>{'my-braid-website'}</Strong> has been successfully
                initialised.
              </Text>
              ...
              <Stack space="large">
                ...
                <Stack space="gutter">
                  ...
                  <Text>
                    ...
                    <TextLink href="https://eslint.org/">ESLint</TextLink>, and
                    more.
                  </Text>
                </Stack>
